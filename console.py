...
lunch = Transaction(2.22, datetime.date(2021, 12, 8), None, greggs, eating_out)
...
lunch = Transaction(2.00, datetime.date(2021, 11, 25), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 11, 26), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 11, 27), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 11, 28), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(3.00, datetime.date(2021, 11, 29), 'Three sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 11, 30), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 1), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 2), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(12.00, datetime.date(2021, 12, 3), 'Twelve sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 4), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 5), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 6), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 7), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 8), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 9), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 10), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(1.70, datetime.date(2021, 12, 11), 'Steak bake', greggs, eating_out)
transaction_repo.save(lunch)
lunch = Transaction(2.00, datetime.date(2021, 12, 12), 'Two sausage rolls', greggs, eating_out)
transaction_repo.save(lunch)
...
yesterday_shop = Transaction(20.00, yesterday, 'Yesterday shop', amazon, electronics)
